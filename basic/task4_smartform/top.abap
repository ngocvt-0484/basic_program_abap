...
SELECT-OPTIONS s_sup FOR v_supplier.
SELECT-OPTIONS s_org FOR v_pur_org.
SELECT-OPTIONS s_pu_gr FOR v_pur_gr.
SELECT-OPTIONS s_ma FOR v_material.
SELECT-OPTIONS s_pur_do FOR v_pur_document.
SELECT-OPTIONS s_item FOR v_item.
SELECT-OPTIONS s_d_date FOR v_document_date.
